...
shadow-sm ring-[0.0625rem] ring-inset ring-input
...
checked:hover:state-layer-primary-active/50 focus-visible:outline
focus-visible:outline-2 focus-visible:outline-offset-2
focus-visible:outline-primary active:bg-neutral-100 active:ring-input-active
active:duration-0 checked:active:bg-primary-active
checked:active:ring-primary-active dark:bg-card dark:active:bg-neutral-800
