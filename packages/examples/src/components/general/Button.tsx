...
data-[variant=link]:cursor-pointer data-[variant=danger]:bg-danger-main
data-[variant=default]:bg-white data-[variant=primary]:bg-primary-main
data-[size=lg]:px-8 data-[size=md]:px-4 data-[size=sm]:px-3
data-[variant=danger]:text-danger-contrast data-[variant=link]:text-neutral-900
data-[variant=primary]:text-primary-contrast
data-[variant=link]:underline-offset-4 data-[variant=flat]:shadow-none
data-[variant=link]:shadow-none data-[variant=danger]:hover:bg-danger-light
data-[variant=default]:hover:bg-neutral-50
data-[variant=flat]:hover:bg-neutral-500/20
data-[variant=primary]:hover:bg-primary-light
data-[variant=link]:hover:underline data-[variant=danger]:active:bg-danger-dark
data-[variant=default]:active:bg-neutral-100
data-[variant=flat]:active:bg-neutral-500/30
data-[variant=primary]:active:bg-primary-dark
